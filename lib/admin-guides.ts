...
export const ADMIN_GUIDES: AdminGuide[] = [
  ...
  {
    id: "whatsapp", title: "Bot de WhatsApp", category: "Automatización", href: "/admin/settings", icon: "whatsapp", feature: "whatsapp", minutes: 10,
    summary: "Atención y toma de pedidos mediante la API oficial de Meta.",
    purpose: "Permitir que clientes consulten menú y generen pedidos conversando por WhatsApp.",
    steps: [
      { title: "Prepará Meta", detail: "Necesitás una aplicación, número habilitado, token permanente y Phone Number ID de la cuenta correcta." },
      { title: "Configurá credenciales", detail: "En la pestaña WhatsApp cargá token, Phone Number ID y token de verificación." },
      { title: "Registrá el webhook", detail: "Usá la URL pública indicada por la plataforma y suscribí los eventos requeridos en Meta." },
      { title: "Probá una conversación", detail: "Consultá menú, armá un pedido y verificá que aparezca en Pedidos Hoy antes de anunciar el canal." },
    ],
    tips: ["Usá únicamente la API oficial de Meta.", "Si cambia el token permanente, actualizalo antes de que venza el anterior."],
    keywords: ["whatsapp", "meta", "bot", "token", "webhook", "phone number id"],
  },
  {
    id: "impresion", title: "Impresión de tickets", category: "Automatización", href: "/admin/settings", icon: "printer", feature: "printNode", minutes: 8,
    summary: "Impresión manual desde navegador o automática mediante PrintNode.",
    purpose: "Enviar comandas a mostrador y cocina con menos intervención operativa.",
    steps: [
      { title: "Elegí el modo", detail: "Navegador abre el diálogo manual. PrintNode envía directamente a impresoras registradas." },
      { title: "Configurá impresoras", detail: "Ingresá IDs o nombres correctos para mostrador y cocina, junto con el ancho del papel." },
      { title: "Activá autoimpresión", detail: "Definí cuándo imprimir: efectivo al crear y pagos online al acreditarse." },
      { title: "Hacé pedidos de prueba", detail: "Probá ambos medios de pago y verificá contenido, destino y ausencia de duplicados." },
    ],
    tips: ["PrintNode requiere configuración de infraestructura por NanoLabs.", "Mantené encendido el equipo que conecta las impresoras."],
    keywords: ["impresora", "ticket", "printnode", "cocina", "mostrador", "papel"],
  },
  {
